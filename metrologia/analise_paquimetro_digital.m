% Análise Metrológica do Paquímetro Digital
...
fprintf('=== ANÁLISE METROLÓGICA DO PAQUÍMETRO DIGITAL ===\n\n');
...
% Exibir estatísticas
fprintf('ESTATÍSTICAS DO PAQUÍMETRO DIGITAL:\n');
...
h_pontos = scatter(valor_real, erro, 100, 'o', 'MarkerEdgeColor', cor_paq, 'MarkerFaceColor', [0.7, 0.7, 1], 'LineWidth', 1.5);
...
title('Curva de erros do Paquímetro Digital', 'FontSize', 16, 'FontWeight', 'bold');
...
print('curva_erros_paquimetro_digital.png', '-dpng', '-r400', '-loose');

fprintf('Análise concluída! Gráfico salvo em: "curva_erros_paquimetro_digital.png"\n'); 