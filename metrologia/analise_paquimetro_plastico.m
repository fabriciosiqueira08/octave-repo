% Análise Metrológica do Paquímetro Analógico de Plástico
...
fprintf('=== ANÁLISE METROLÓGICA DO PAQUÍMETRO ANALÓGICO DE PLÁSTICO ===\n\n');
...
% Exibir estatísticas
fprintf('ESTATÍSTICAS DO PAQUÍMETRO ANALÓGICO DE PLÁSTICO:\n');
...
h_pontos = scatter(valor_real, erro, 100, 's', 'MarkerEdgeColor', cor_paq, 'MarkerFaceColor', [1, 0.7, 0.7], 'LineWidth', 1.5);
...
title('Curva de erros do Paquímetro Analógico de Plástico', 'FontSize', 16, 'FontWeight', 'bold');
...
print('curva_erros_paquimetro_plastico.png', '-dpng', '-r400', '-loose');

fprintf('Análise concluída! Gráfico salvo em: "curva_erros_paquimetro_plastico.png"\n'); 